...
export async function POST(request: Request) {
    try {
        ...
        const templates: Record<string, string> = {
            ...
            corporate_minimalist: `${objectDescription}, flat vector illustration, corporate minimalist style, clean lines, 2D, soft muted color palette, beige and cream background, navy blue and grey accents, professional and academic atmosphere, wide shot, plenty of negative space on the right side for text, high quality, unspalsh style --ar 16:9`,

            medical_tribute: `Flat vector illustration of ${objectDescription}. Composition is symmetrical, front-facing, and stable to convey trust and professionalism. Characters are stylized with simple geometric features. Background is a solid soft mint-green or teal color block. Art style: Clean flat vector, simplified shapes, no outlines. Color Palette: Teal, Mint Green, White, and warm skin tones. --no text, no letters, no typography`,
            ...
            care_community: `Flat vector illustration of ${objectDescription}. The atmosphere is nurturing, compassionate, and welcoming. Surroundings include stylized soft rounded shapes, interlocking circles, and warm light elements. Background features soft abstract gradients in coral or warm peach. Art style: Modern flat design, human-centric aesthetic, gentle and inviting colors. Color Palette: Coral, Warm Pink, Soft Gold, and White. --no text, no letters, no typography`,
            ...
            healthy_lifestyle: `Flat vector illustration of ${objectDescription}. Clean lines, pastel green and white color palette, medical and health theme, minimalist icons. The image should feature a top-down view of healthy elements or a person engaging in healthy activities (jogging, eating well) in a flat vector style. Atmosphere is fresh, clean, and positive. --no text, no letters, no typography`,

            evolution_comparison: `3D Pixar-style cartoon illustration of ${objectDescription}. High contrast lighting, detailed environment. Comparing "The Past" (messy, manual, dim lighting) vs "The Present" (futuristic, automated, bright lighting). Detailed characters showing expressions of confusion vs happiness. Futuristic technology holograms vs old manual tools. --no text, no letters, no typography`
        };
