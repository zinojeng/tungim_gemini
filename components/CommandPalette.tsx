...
const STATIC_COMMANDS: CommandItem[] = [
  ...
  },
  {
    ...
    keywords: ["glp-1", "sglt2", "t1d", "t2d", "gdm"],
  },
  {
    id: "cat:endocrinology",
    title: "內分泌 · Endocrinology",
    section: "學科",
    kind: "navigate",
    href: "/lectures?search=Endocrinology",
    keywords: ["thyroid", "adrenal", "pituitary", "bone"],
  },
  {
    id: "cat:internal",
    title: "一般內科 · Internal Medicine",
    section: "學科",
    kind: "navigate",
    href: "/lectures?search=Internal+Medicine",
    keywords: ["cardio", "renal", "gi", "infection"],
  },
  {
    id: "cat:other",
    title: "其他主題 · Other",
